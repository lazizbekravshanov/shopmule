...
export function FinalCTA() {
  ...
  const inputClass =
    'w-full h-11 px-4 text-sm bg-white border border-neutral-200 rounded-lg text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#ee7a14]/20 focus:border-[#ee7a14] transition-all';
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full h-11 bg-[#ee7a14] hover:bg-[#d96a0a] disabled:bg-neutral-200 disabled:text-neutral-400 text-white font-medium rounded-lg transition-all flex items-center justify-center gap-2 text-sm"
              >
                {isSubmitting ? (
                  <>
